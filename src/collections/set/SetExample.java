...
// | Использование                      | Подходит?                |
//| ---------------------------------- | ------------------------ |
//| Уникальные значения                | ✅ Да                     |
//| Частый поиск/проверка наличия      | ✅ Да                     |
//| Нужно сохранить порядок добавления | ➖ Только `LinkedHashSet` |
//| Нужно отсортировать элементы       | ➖ Только `TreeSet`       |
//| Нужны дубликаты                    | ❌ Нет                    |
